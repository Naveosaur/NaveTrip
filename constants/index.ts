...
export const NAV_LINKS = [
  ...
  { href: "/", key: "HowWe", label: "How We Work" },
  { href: "/", key: "getApp ", label: "Get App" },
...
export const FEATURES = [
  {
    ...
    icon: "/map.svg",
    variant: "green",
    description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eligendi corporis suscipit repellendus laboriosam aperiam cupiditate doloremque architecto, rerum placeat debitis",
  },
  {
    title: "Lorem ipsum dolor sit",
    icon: "/calendar.svg",
...
export const FOOTER_LINKS = [
  {
    title: "Learn More",
    links: ["About Navetrip", "Jobs", "Privacy Policy"],
  },
  {
    title: "Our Community",
    links: ["Climbing ", "Hiking ", "Travel"],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: "Email ", value: "Navetrip@admin.com" },
  ],
};
